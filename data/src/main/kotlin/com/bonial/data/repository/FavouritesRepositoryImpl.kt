...
class FavouritesRepositoryImpl @Inject constructor(
    ...
    override fun isFavouriteFlow(coverUrl: String): Flow<Boolean> =
        favouritesDao.isFavouriteFlow(coverUrl)

    override fun getFavouriteCoverUrls(): Flow<Set<String>> =
        favouritesDao.getAllCoverUrls().map { it.toSet() }
}
